...
setInterval(() => {
  http.get(`http://ghost12.glitch.me/`);
}, 280000);
...
const youtube = new YouTube('AIzaSyAlhv_VbJ615kVHeUldN4G-JKSiwSTc3Ew');
const hastebins = require('hastebin-gen');
const getYoutubeID = require('get-youtube-id');
const yt_api_key = "AIzaSyAlhv_VbJ615kVHeUldN4G-JKSiwSTc3Ew";
...
let g = client.guilds.get("597608601137184810"); // id server
let c = g.channels.get("651765581611139072");// id channel
if(c.type === 'voice') {
c.join();
setInterval(() => {
...
> skipto [st] : لتخطي الأغنية الى الأغنية القادمة في طابور الموسيقى القادمة
